...
"""
Training script - Window length 64, Overlap 32
Train using data with win64_overlap32 configuration
"""
...
class IGANEEGTrainer:
    ...
    def train_generator(self, batch_size: int) -> float:
        ...
        # Convert generated EEG to format required by discriminator
        fake_eeg_reshaped = fake_eeg.unsqueeze(1).expand(-1, 64, -1)
