...
"""
IGANEEG Model Test Script - Window 64, Overlap 0
Test configuration: Window length 64, Overlap length 0
"""
...
class IGANEEGTester:
    def __init__(self, config_name="win64_overlap0"):
...
def main():
    """Main function"""
    print("IGANEEG Model Test - Window 64, Overlap 0")
    print("=" * 60)

    # Create tester
    tester = IGANEEGTester("win64_overlap0")
