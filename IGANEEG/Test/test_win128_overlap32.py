...
"""
IGANEEG Model Test Script - Window 128, Overlap 32
Test configuration: Window length 128, Overlap length 32
"""
...
class IGANEEGTester:
    def __init__(self, config_name="win128_overlap32"):
...
def main():
    """Main function"""
    print("IGANEEG Model Test - Window 128, Overlap 32")
    print("=" * 60)

    # Create tester
    tester = IGANEEGTester("win128_overlap32")
