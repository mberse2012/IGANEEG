...
"""
IGANEEG Model Test Script - Window 128, Overlap 0
Test configuration: Window length 128, Overlap length 0
"""
...
class IGANEEGTester:
    def __init__(self, config_name="win128_overlap0"):
...
def main():
    """Main function"""
    print("IGANEEG Model Test - Window 128, Overlap 0")
    print("=" * 60)

    # Create tester
    tester = IGANEEGTester("win128_overlap0")
